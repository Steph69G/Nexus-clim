/*
  # Fix KPI function - correct survey column

  1. Changes
    - Change submitted_at to completed_at for surveys
*/
...
BEGIN
  ...
  AND updated_at >= start_of_month 
  AND updated_at < end_of_month 
  AND updated_at <= scheduled_start + interval '2 hours';
