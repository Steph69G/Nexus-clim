...
export default function ChatBubble() {
  ...
  return (
    <button
      ...
      role="button"
      onClick={toggleOpen}
      className="fixed bottom-6 right-6 md:bottom-6 md:right-6 z-[100] h-14 w-14 rounded-full bg-sky-100 border border-sky-200 shadow-xl hover:bg-sky-200 focus:outline-none focus:ring-2 focus:ring-sky-400 transition-all duration-300"
    >
