    ...
    <header className="bg-white border-b border-slate-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            <NavItem to="/admin" icon={<LayoutDashboard className="w-4 h-4" />}>Accueil</NavItem>
            ...
            <NavItem to="/admin/clients" icon={<Users className="w-4 h-4" />}>Clients</NavItem>
            <NavItem to="/admin/communication" icon={<MessageSquare className="w-4 h-4" />}>Communication</NavItem>
            <NavItem to="/admin/ressources" icon={<UserCog className="w-4 h-4" />}>Ressources</NavItem>
            <NavItem to="/admin/logistique" icon={<Package className="w-4 h-4" />}>Logistique</NavItem>
            <NavItem to="/admin/pilotage" icon={<TrendingUp className="w-4 h-4" />}>Pilotage</NavItem>
          </nav>
        </div>
      ...
      <div className="lg:hidden border-t border-slate-200 bg-slate-50 px-4 py-2">
        <nav className="flex gap-2 overflow-x-auto">
          <MobileNavItem to="/admin" icon={<LayoutDashboard className="w-4 h-4" />} />
          ...
          <MobileNavItem to="/admin/clients" icon={<Users className="w-4 h-4" />} />
          <MobileNavItem to="/admin/communication" icon={<MessageSquare className="w-4 h-4" />} />
          <MobileNavItem to="/admin/ressources" icon={<UserCog className="w-4 h-4" />} />
          <MobileNavItem to="/admin/logistique" icon={<Package className="w-4 h-4" />} />
          <MobileNavItem to="/admin/pilotage" icon={<TrendingUp className="w-4 h-4" />} />
        </nav>
      </div>
    </header>
  );
