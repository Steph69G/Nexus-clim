...
export default function SubcontractorProfilePage() {
  ...
  const [locationMode, setLocationMode] = useState<"fixed_address" | "gps_realtime">("fixed_address");
  ...
  useEffect(() => {
    ...
    setLocationMode((profile.location_mode as "fixed_address" | "gps_realtime") ?? "fixed_address");
    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-4xl mx-auto px-4 space-y-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-slate-900 mb-4">Profil Sous-traitant</h1>
        ...
        <section className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl">
          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="text-center md:text-left">
              <label className="inline-flex items-center gap-3 bg-emerald-600 text-white px-6 py-3 rounded-2xl cursor-pointer hover:bg-emerald-700 transition-all transform hover:scale-105 shadow-xl font-medium">
        ...
        <form onSubmit={onSave} className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-12 pr-4 py-4 text-slate-900 placeholder-slate-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none transition-all" 
                    value={profile.email ?? ""} 
                    disabled 
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    className="w-full bg-white border border-slate-300 rounded-2xl pl-12 pr-4 py-4 text-slate-900 placeholder-slate-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none transition-all" 
                    value={full_name} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input 
                      className="w-full bg-slate-50 border border-slate-300 rounded-2xl pl-12 pr-4 py-4 text-slate-600 placeholder-slate-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none transition-all" 
                      value={profile.role ?? "—"} 
                      disabled 
                    />
                  </div>
          ...
          <section className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">Position basée sur l'adresse professionnelle (recommandé pour sous-traitants)</div>
                    </div>
                  </label>
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                    ...
                    <div>
                      ...
                      <div className="text-sm text-slate-600">Position mise à jour via GPS mobile (pour techniciens en déplacement)</div>
                    </div>
                  </label>
                </div>
              </div>
              ...
              <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-2xl">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <label htmlFor="share_location" className="block font-medium text-slate-900 cursor-pointer">
                      📡 Partager ma position GPS en temps réel
                    </label>
                    <p className="text-sm text-slate-600 mt-1">
                      En activant cette option, votre patron pourra voir votre position GPS en temps réel sur la carte pendant vos interventions.
                      Vous pouvez désactiver cette option à tout moment.
                    </p>
                    {shareLocation && (
                      <div className="mt-3 p-3 bg-white border border-emerald-300 rounded-xl">
                        <p className="text-sm font-medium text-emerald-800">
                          ✅ Partage actif - Votre position est visible par l'administrateur
                        </p>
                      </div>
                    )}
                  </div>
              ...
              <div>
                ...
                <GoogleAddressInput
                  ...
                  className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-4 text-slate-900 placeholder-slate-500 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none transition-all"
                  ...
                  <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-2xl">
                    <div className="flex items-start justify-between gap-4">
                      <div>
                        ...
                        <p className="text-emerald-700">{fullGoogleAddress}</p>
                      </div>
                      <button
                        type="button"
                        onClick={() => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select 
                    className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-4 text-slate-900 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 focus:outline-none transition-all" 
                    value={radiusKm} 
            ...
            <div className="mt-8">
              <button 
                disabled={busy} 
                className="w-full bg-emerald-600 text-white py-4 rounded-2xl font-semibold hover:bg-emerald-700 disabled:opacity-50 transition-all transform hover:scale-105 shadow-xl flex items-center justify-center gap-3"
              >
                {busy ? (
                  <>
        ...
        <section className="bg-white rounded-2xl p-8 border border-slate-200 shadow-xl">
          ...
          <form onSubmit={onChangePassword} className="space-y-6">
            ...
            <button 
              disabled={pwdBusy} 
              className="w-full bg-emerald-600 text-white py-4 rounded-2xl font-semibold hover:bg-emerald-700 disabled:opacity-50 transition-all transform hover:scale-105 shadow-xl"
            >
